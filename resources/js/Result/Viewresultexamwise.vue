...
<tbody>
  ...
  <tr v-for="(v_department,index) in result">
...
<!---
<td style="text-align:center;padding-top:30px;color:blue;font-weight:bold">{{v_department.university_semesterfinal_mark_addeddate}}</td>
...
methods:{
  ...
  viewallresultexamwise(){

    axios.get('/show_all_result_exam_wise/'+this.$route.params.exm_id).then((res) => {
