<template>
 ...
 <div class="card card-primary" style="width:550px;margin-top:25px;margin-left:270px;width:80%">
...
<div class="card-body">
                ...
                <input v-model="form.fine_duration" type="number" name="fine_duration"
                class="form-control" :class="{ 'is-invalid': form.errors.has('fine_duration') }" placeholder="Enter Semester Fee Fine Day">
                <has-error :form="form" field="fine_duration"></has-error>
                </div>
                ...
                <input v-model="form.student_givesemesterfee_expire_date" type="text" name="student_givesemesterfee_expire_date"
                class="form-control" :class="{ 'is-invalid': form.errors.has('student_givesemesterfee_expire_date') }" placeholder="Semester Fee Expire Date">
                <has-error :form="form" field="student_givesemesterfee_expire_date"></has-error>
                </div>
      ...
      data () {
        ...
        //  allbatch:{},
          ...
          form: new Form({
             ...
             student_givesemesterfee_expire_date:'',
            //
     ...
     this.form.post('/update_student_semester_fee/'+this.$route.params.student_givesemesterfee_id)
        .then((response)=>{
             ...
             if(response.data==1){
               ...
               this.$router.push('/take_studentsemester_fee')
