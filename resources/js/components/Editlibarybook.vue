...
<div class="card-header">
  <h3 class="card-title">Edit Libary Book</h3>
...
<div class="card-body">
                ...
                <div class="form-group">
                  ...
                  class="form-control" :class="{ 'is-invalid': form.errors.has('libary_book_added_date') }" placeholder="07-04-2021">
...
// }
        ...
        axios.get('/edit_libarybook_placeholder_value/'+this.$route.params.libary_book_id)
        .then((response)=>{
