      ...
      <MyBackendsidebar></MyBackendsidebar>
        ...
        <div class="main">
                 <div class="title" style="width:1000px;float:left">
                   <h3 class="card-title">Student Pending Libary Book</h3>
                 </div>
...
<router-link :to="`/view_libary_book_frontend/${v_show.studenttake_libary_book_id}`" class="btn btn-danger btn-sm" style="margin-top:17px;" ><i class="fa fa-eye" aria-hidden="true" style="color:white;"></i></router-link>
...
<script>
   ...
   import Mybackendfooter from "../backendlayout/Adminfooter.vue"
    ...
    methods:{
     ...
     axios.get('/show_all_libary_book_student_take/'+this.$route.params.student_id).then((res) => {
